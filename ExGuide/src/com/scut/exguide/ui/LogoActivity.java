...
import com.scut.exguide.utils.DataUtil;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		aa.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation arg0) {
				...
				Intent it ;
				if (DataUtil.isFirstTime(getApplicationContext())) {
					it= new Intent(LogoActivity.this,
							ExGuideTutorialsActivity.class);
					DataUtil.SetFirstUse(getApplicationContext());
				}else{
					it= new Intent(LogoActivity.this,
